...
Image pairs are expected to be labeled `00*.mat` (reference/undeformed) and `01*.mat` (deformed). A synthetic image pair for a standardized Hertzian contact scenario is included.
