...
It accompanies our manuscript that describes and evaluates the approaches:
...
We provide a [directory containing a runner script](./Hertzian%20contact%20runner%20script) for an exemplary simulated Hertzian contact scenario (applying both the volume and the surface method), together with the [Matlab files](./Hertzian%20contact%20runner%20script/Matlab%20files) for the FIDVC, and example data and results.
